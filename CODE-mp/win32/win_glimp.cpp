...
static void GLW_InitExtensions( qboolean createFakeContext = qfalse )
{
		...
		strstr(glConfig.extensions_string, "GL_ARB_shading_language_100"))
	{
		...
		qglVertexAttribPointer = (void (APIENTRY*) (GLuint, GLint, GLenum, GLboolean, GLsizei, const void*)) qwglGetProcAddress("glVertexAttribPointer"); // not sure if this is the right extension
		qglVertexAttribIPointer = (void (APIENTRY*) (GLuint, GLint, GLenum, GLsizei, const void*)) qwglGetProcAddress("glVertexAttribIPointer"); // not sure if this is the right extension
		qglVertexAttribDivisor = (void (APIENTRY*) (GLuint, GLint, GLenum, GLsizei, const void*)) qwglGetProcAddress("glVertexAttribDivisor"); // not sure if this is the right extension
		qglEnableVertexAttribArray = (void (APIENTRY*) (GLuint)) qwglGetProcAddress("glEnableVertexAttribArray"); // not sure if this is the right extension
		qglDisableVertexAttribArray = (void (APIENTRY*) (GLuint)) qwglGetProcAddress("glDisableVertexAttribArray"); // not sure if this is the right extension
