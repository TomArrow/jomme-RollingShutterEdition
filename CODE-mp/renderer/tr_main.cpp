...
*/
// this function is from MESA source code. Relevant license note from the file:
/*
...
========================
*/
qboolean R_MirrorViewBySurface (drawSurf_t *drawSurf, int64_t entityNum, int hackPortalNum) {
	vec4_t			clipDest[128];
