...
static void CG_EntityEffects( centity_t *cent ) {
	...
	if ( cent->currentState.constantLight ) {
		...
		b = ( cl >> 16 ) & 255;
		i = ( ( cl >> 24 ) & 255 ) * 4;
		trap_R_AddLightToScene( cent->lerpOrigin, i, r, g, b, 0.0f,qfalse );
	}
	...
	if ( cent->currentState.eFlags & EF_ALT_FIRING )
	{
		...
		if ( weapon->altMissileDlight ) 
		{
			trap_R_AddLightToScene(cent->lerpOrigin, weapon->altMissileDlight, 
				weapon->altMissileDlightColor[0], weapon->altMissileDlightColor[1], weapon->altMissileDlightColor[2], 0.0f, qfalse);
		}
	...
	else
	{
		...
		if ( weapon->missileDlight ) 
		{
			trap_R_AddLightToScene(cent->lerpOrigin, weapon->missileDlight, 
				weapon->missileDlightColor[0], weapon->missileDlightColor[1], weapon->missileDlightColor[2], 0.0f, qfalse);
		}
